...
#expr = egraph.let("expr", a @ b.mat_trans().mat_inv())
#expr = egraph.let("expr", d + e)
#expr = egraph.let("expr", f @ (d + (e @ (g + h))))
#expr = egraph.let("expr", (((g + h) @ e) + d) @ f)
#expr = egraph.let("expr", f @ (d + e))
#expr = egraph.let("expr", (d + e) @ f)
#expr = egraph.let("expr", g.kron(f.mat_trans()))
#expr = egraph.let("expr", g.mat_trans().kron(f))
